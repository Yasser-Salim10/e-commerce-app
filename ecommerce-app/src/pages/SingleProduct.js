                        ...
                        <div className='main-product-details'>
                            ...
                            <div className='border-bottom py-3'>
                                <div className=' d-flex gap-10 align-items-center'>
                                    ...
                                    <p className='product-date my-2'>Watch</p>
                                </div>
                                <div className=' d-flex gap-10 align-items-center'>
                                    <h3 className='product-heading'>Brand:</h3>
                                    <p className='product-date my-2'>Hevels</p>
                                </div>
                                <div className=' d-flex gap-10 align-items-center'>
                                ...
                                <div className=' d-flex gap-10 align-items-center'>
                                    ...
                                    <p className='product-date my-2'>In Stack</p>
                                </div>
                                ...
                                <div className=' d-flex align-items-center gap-15'>
                                    ...
                                    <div>
                                        <a href='' ><AiOutlineHeart className='fs-5 me-2'rt/> Add to WishList</a>
                                    </div>
                                </div>
                                <div className=' d-flex gap-10 flex-column my-3'>
                                    <h3 className='product-heading'>Shipping & Returns:</h3>
                                    <p className='product-date my-2'>
