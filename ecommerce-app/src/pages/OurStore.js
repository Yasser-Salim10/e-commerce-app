        ...
        <Container class1='store-wrapper home-wrapper-2 py-5'>
                <div className='row'>
                    <div className='col-3'>
                            ...
                            <div>
                                ...
                                <div>
                                    <div className="form-check">
                                        ...
                                        id="color-1"
                                        />
                                        <label className='form-control-label' htmlFor="color-1">
                                            S (2)
                                            </label>
                                    </div>
                                    <div className="form-check">
                                        ...
                                        id="color-2"
                                        />
                                        <label className='form-control-label' htmlFor="color-2">
                                            M (2)
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div className='filter-card mb-3'>
                            <h3 className='filter-title'>Filter Tag</h3>
                            <div className='paroduct-tags d-flex flex-wrap align-items-center gap-10'>
