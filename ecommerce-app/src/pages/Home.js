  ...
  return (
    ...
    <Container class1='home-wrapper-1 py-5'>
              ...
              <div className='d-flex flex-wrap gap-10 justify-content-between align-items-center'>
                ...
                <div className='small-banner position-relative'>
                  ...
                  <div className='small-banner-content position-absolute'>
                    ...
                    <h5>AirPods Max</h5>
                    <p>
                      High-fidakity playback &<br /> ultra low distoration
                    </p>
                  </div>
                </div>
              </div>
      ...
      <Container class1='featured-wrapper home-wrapper-2 py-5'>
        <div className='row'>
            <div className='col-12'>
              <h3 className='section-heading'>Feauterd  Collection</h3>
            </div>
            <ProductCard/>
            <ProductCard/>
            <ProductCard/>
        ...
        <div className='row'>
            <div className='col-3'>
              <div className='famouse-card position-relative'>
                <img className='img-fluid' src='images/famous-1.webp'alt='famouse'/>
            ...
            <div className='col-3'>
              <div className='famouse-card position-relative'>
                <img className='img-fluid' src='images/famous-2.webp'alt='famouse'/>
                <div className='famous-content position-absolute'>
                  <h5 className=' text-dark'>Stodio Display</h5>
            ...
            <div className='col-3'>
              <div className='famouse-card position-relative'>
                <img className='img-fluid' src='images/famous-3.webp'alt='famouse'/>
                <div className='famous-content position-absolute'>
            ...
            <div className='col-3'>
              <div className='famouse-card position-relative'>
                <img className='img-fluid' src='images/famous-4.webp'alt='famouse'/>
                <div className='famous-content position-absolute'>
